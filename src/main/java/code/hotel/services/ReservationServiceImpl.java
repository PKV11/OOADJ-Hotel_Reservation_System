...
public class ReservationServiceImpl implements ReservationService {
	...
	public void saveOrUpdateReservation(CurrentReservation currentReservation) {
		...
		// Set the default status to "reserved"
	...
	@Override
	@Transactional
	public void bookRoom(CurrentReservation currentReservation) {
		Reservation reservation = new Reservation();
		// Populate reservation object with data from currentReservation
		// Example: reservation.setArrivalDate(currentReservation.getArrivalDate());
	...
	public void checkInReservation(int reservationId) {
		...
		// Assuming you have a setStatus method in your Reservation entity
